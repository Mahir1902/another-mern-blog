...
export default function Featured() {
  return (
    <div className='mt-8'>
      ...
      <h1 className='text-[6rem]'><b>Hey there!</b> Discover my sotries and creative ideas</h1>

      {/* posts */}
      <div className=' mt-[4rem] flex items-center gap-[3.125rem]'>
        <div className='flex-1 h-[31.25rem] object-cover relative'>
        ...
        <div className='flex-1 flex flex-col gap-5'>
          <h1 className='text-[2.5rem] font-semibold'>Lorem ipsum dolor, sit amet consectetur adipisicing elit.</h1>
          <p className='text-[1.25rem] text-softTextColor'>
          ...
          <button className='px-5 py-3 dark:bg-white w-[8rem] rounded-md dark:text-black font-semibold bg-softBg'>
            Read More
          </button>
        </div>
      </div>
